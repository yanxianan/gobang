...
public final class ItemRecordBinding implements ViewBinding {
  ...
  private ItemRecordBinding(@NonNull LinearLayout rootView, @NonNull TextView tvPlayers,
      @NonNull TextView tvResult, @NonNull TextView tvRoom, @NonNull TextView tvTime) {
  ...
  public static ItemRecordBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemRecordBinding((LinearLayout) rootView, tvPlayers, tvResult, tvRoom, tvTime);
    }
